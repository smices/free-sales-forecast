...
function E(e) {
  const a = e.trim();
  if (a.length === 0)
    throw new Error("Avatar hash must not be blank.");
  return a;
}
function U(e) {
  let a = 2166136261;
  for (let l = 0; l < e.length; l += 1)
    a ^= e.charCodeAt(l), a = Math.imul(a, 16777619);
  return a >>> 0;
}
function t1(e, a, l) {
  if (a <= 0)
    throw new Error("Cannot select from an empty avatar part list.");
  let t = e + Math.imul(l + 1, 2654435761);
  return t ^= t >>> 16, t = Math.imul(t, 2246822507), t ^= t >>> 13, t = Math.imul(t, 3266489909), t ^= t >>> 16, (t >>> 0) % a;
}
function N() {
  const e = globalThis.crypto;
  return e != null && e.getRandomValues ? e.getRandomValues(new Uint32Array(1))[0] ?? 0 : Math.floor(Math.random() * 4294967296) >>> 0;
}
function c1() {
  return `${l1}-${N().toString(36)}-${N().toString(36)}:${N().toString(36)}`;
}
function d(e) {
...
function r1(e) {
  var a, l, t, c, r, i, s;
  const o = (a = e.meta) === null || a === void 0 ? void 0 : a.title, u = (l = e.meta) === null || l === void 0 ? void 0 : l.creator, f = (t = e.meta) === null || t === void 0 ? void 0 : t.source, h = (r = (c = e.meta) === null || c === void 0 ? void 0 : c.license) === null || r === void 0 ? void 0 : r.url, p = n1(e);
  return !o && !u && !f && !h && !p ? "" : '<metadata xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dcterms="http://purl.org/dc/terms/"><rdf:RDF><rdf:Description>' + (o ? `<dc:title>${d(o)}</dc:title>` : "") + (u ? `<dc:creator>${d(u)}</dc:creator>` : "") + (f ? `<dc:source xsi:type="dcterms:URI">${d((s = (i = e.meta) === null || i === void 0 ? void 0 : i.source) !== null && s !== void 0 ? s : "")}</dc:source>` : "") + (h ? `<dcterms:license xsi:type="dcterms:URI">${d(h)}</dcterms:license>` : "") + (p ? `<dc:rights>${d(p)}</dc:rights>` : "") + "</rdf:Description></rdf:RDF></metadata>";
}
function n1(e) {
  var a, l, t, c, r, i, s, o, u, f, h, p, $, C, Z;
  let y = !((a = e.meta) === null || a === void 0) && a.title ? `„${(l = e.meta) === null || l === void 0 ? void 0 : l.title}”` : "Design", H = `„${(c = (t = e.meta) === null || t === void 0 ? void 0 : t.creator) !== null && c !== void 0 ? c : "Unknown"}”`;
  !((r = e.meta) === null || r === void 0) && r.source && (y += ` (${e.meta.source})`);
  let _ = "";
  return ((s = (i = e.meta) === null || i === void 0 ? void 0 : i.license) === null || s === void 0 ? void 0 : s.name) !== "MIT" && ((o = e.meta) === null || o === void 0 ? void 0 : o.creator) !== "DiceBear" && (!((u = e.meta) === null || u === void 0) && u.title) && (_ += "Remix of "), _ += `${y} by ${H}`, !((h = (f = e.meta) === null || f === void 0 ? void 0 : f.license) === null || h === void 0) && h.name && (_ += `, licensed under „${($ = (p = e.meta) === null || p === void 0 ? void 0 : p.license) === null || $ === void 0 ? void 0 : $.name}”`, !((Z = (C = e.meta) === null || C === void 0 ? void 0 : C.license) === null || Z === void 0) && Z.url && (_ += ` (${e.meta.license.url})`)), _;
}
const P = -2147483648, i1 = 2147483647;
function I(e) {
...
function o1(e) {
  ...
  for (let l = 0; l < e.length; l++)
    a = (a << 5) - a + e.charCodeAt(l) | 0, a = I(a);
  return a;
}
function F(e = "") {
  e = e.toString();
  let a = o1(e) || 1;
  const l = () => a = I(a), t = (c, r) => Math.floor((l() - P) / (i1 - P) * (r + 1 - c) + c);
  return {
    seed: e,
    next: l,
    bool(c = 50) {
    ...
    pick(c, r) {
      var i;
      return c.length === 0 ? (l(), r) : (i = c[t(0, c.length - 1)]) !== null && i !== void 0 ? i : r;
    },
    shuffle(c) {
      const r = F(l().toString()), i = [...c];
      for (let s = i.length - 1; s > 0; s--) {
        const o = r.integer(0, s);
        [i[s], i[o]] = [i[o], i[s]];
      }
      return i;
    },
    string(c, r = "abcdefghijklmnopqrstuvwxyz1234567890") {
      const i = F(l().toString());
      let s = "";
      for (let o = 0; o < c; o++)
        s += r[i.integer(0, r.length - 1)];
      return s;
    }
  };
}
function x(e) {
  let a = e.attributes.viewBox.split(" "), l = parseInt(a[0]), t = parseInt(a[1]), c = parseInt(a[2]), r = parseInt(a[3]);
  return {
    x: l,
    y: t,
    width: c,
...
function d1(e, a, l, t, c) {
  let { width: r, height: i, x: s, y: o } = x(e);
  const u = `<rect fill="${a}" width="${r}" height="${i}" x="${s}" y="${o}" />`;
  switch (t) {
    case "solid":
      return u + e.body;
    case "gradientLinear":
      return `<rect fill="url(#backgroundLinear)" width="${r}" height="${i}" x="${s}" y="${o}" /><defs><linearGradient id="backgroundLinear" gradientTransform="rotate(${c} 0.5 0.5)"><stop stop-color="${a}"/><stop offset="1" stop-color="${l}"/></linearGradient></defs>` + e.body;
  }
}
function s1(e, a) {
  let { width: l, height: t, x: c, y: r } = x(e), i = a ? (a - 100) / 100 : 0, s = (l / 2 + c) * i * -1, o = (t / 2 + r) * i * -1;
  return `<g transform="translate(${s} ${o}) scale(${a / 100})">${e.body}</g>`;
}
function f1(e, a, l) {
  let t = x(e), c = (t.width + t.x * 2) * ((a ?? 0) / 100), r = (t.height + t.y * 2) * ((l ?? 0) / 100);
  return `<g transform="translate(${c} ${r})">${e.body}</g>`;
}
function u1(e, a) {
  let { width: l, height: t, x: c, y: r } = x(e);
  return `<g transform="rotate(${a}, ${l / 2 + c}, ${t / 2 + r})">${e.body}</g>`;
}
function h1(e) {
  let { width: a, x: l } = x(e);
  return `<g transform="scale(-1 1) translate(${a * -1 - l * 2} 0)">${e.body}</g>`;
}
function p1(e, a) {
  let { width: l, height: t, x: c, y: r } = x(e), i = a ? l * a / 100 : 0, s = a ? t * a / 100 : 0;
  return `<mask id="viewboxMask"><rect width="${l}" height="${t}" rx="${i}" ry="${s}" x="${c}" y="${r}" fill="#fff" /></mask><g mask="url(#viewboxMask)">${e.body}</g>`;
}
function v1(e) {
  const a = {
  ...
  return Object.keys(a).map((l) => `${d(l)}="${d(a[l])}"`).join(" ");
}
function m1(e) {
  const a = F(Math.random().toString()), l = {};
  return e.body.replace(/(id="|url\(#)([a-z0-9-_]+)([")])/gi, (t, c, r, i) => (l[r] = l[r] || a.string(8), `${c}${l[r]}${i}`));
}
const g1 = {
  properties: {
    seed: {
...
function R(e) {
  var a;
  let l = {}, t = (a = e.properties) !== null && a !== void 0 ? a : {};
  return Object.keys(t).forEach((c) => {
    let r = t[c];
    typeof r == "object" && r.default !== void 0 && (Array.isArray(r.default) ? l[c] = [...r.default] : typeof r.default == "object" ? l[c] = { ...r.default } : l[c] = r.default);
  }), l;
}
function Z1(e, a) {
  var l;
  let t = {
    ...R(g1),
    ...R((l = e.schema) !== null && l !== void 0 ? l : {}),
    ...a
  };
  return JSON.parse(JSON.stringify(t));
}
function T(e) {
  return e === "transparent" ? e : `#${e}`;
}
function M1(e, a, l) {
  var t;
  let c = e.shuffle(a);
  c.length <= 1 || a.length == 2 && l == "gradientLinear" ? (c = a, e.next()) : c = e.shuffle(a), c.length === 0 && (c = ["transparent"]);
  const r = c[0], i = (t = c[1]) !== null && t !== void 0 ? t : c[0];
  return {
    primary: T(r),
    secondary: T(i)
  };
...
function y1(e, a = {}) {
  var l, t, c, r, i;
  a = Z1(e, a);
  const s = F(a.seed), o = e.create({ prng: s, options: a }), u = s.pick((l = a.backgroundType) !== null && l !== void 0 ? l : [], "solid"), { primary: f, secondary: h } = M1(s, (t = a.backgroundColor) !== null && t !== void 0 ? t : [], u), p = s.integer(!((c = a.backgroundRotation) === null || c === void 0) && c.length ? Math.min(...a.backgroundRotation) : 0, !((r = a.backgroundRotation) === null || r === void 0) && r.length ? Math.max(...a.backgroundRotation) : 0);
  a.size && (o.attributes.width = a.size.toString(), o.attributes.height = a.size.toString()), a.scale !== void 0 && a.scale !== 100 && (o.body = s1(o, a.scale)), a.flip && (o.body = h1(o)), a.rotate && (o.body = u1(o, a.rotate)), (a.translateX || a.translateY) && (o.body = f1(o, a.translateX, a.translateY)), f !== "transparent" && h !== "transparent" && (o.body = d1(o, f, h, u, p)), (a.radius || a.clip) && (o.body = p1(o, (i = a.radius) !== null && i !== void 0 ? i : 0)), a.randomizeIds && (o.body = m1(o));
  const $ = v1(o), C = r1(e), Z = `<svg ${$}>${C}${o.body}</svg>`;
  return {
    toString: () => Z,
    toJson: () => {
      var y;
...
function M({ prng: e, group: a, values: l = [] }) {
  const t = V1, c = e.pick(l);
  if (c && t[a][c])
    return {
      name: c,
      value: t[a][c]
...
function F1({ prng: e, options: a }) {
  ...
  return {
    ...
    eyes: s,
    eyebrows: o,
    top: e.bool(a.topProbability) ? u : void 0,
    facialHair: e.bool(a.facialHairProbability) ? f : void 0,
    accessories: e.bool(a.accessoriesProbability) ? h : void 0,
    clothingGraphic: p
  };
}
function k(e) {
...
function N1({ prng: e, options: a }) {
  var l, t, c, r, i, s, o;
  return {
    accessories: k(e.pick((l = a.accessoriesColor) !== null && l !== void 0 ? l : [], "transparent")),
    clothes: k(e.pick((t = a.clothesColor) !== null && t !== void 0 ? t : [], "transparent")),
    hat: k(e.pick((c = a.hatColor) !== null && c !== void 0 ? c : [], "transparent")),
    hair: k(e.pick((r = a.hairColor) !== null && r !== void 0 ? r : [], "transparent")),
    skin: k(e.pick((i = a.skinColor) !== null && i !== void 0 ? i : [], "transparent")),
    facialHair: k(e.pick((s = a.facialHairColor) !== null && s !== void 0 ? s : [], "transparent")),
    background: k(e.pick((o = a.backgroundColor) !== null && o !== void 0 ? o : [], "transparent"))
  };
}
function B1({ prng: e, options: a, components: l, colors: t }) {
  var c, r, i;
  ((c = l.style) === null || c === void 0 ? void 0 : c.name) === "circle" && (a.backgroundColor = []), ((r = l.style) === null || r === void 0 ? void 0 : r.name) !== "circle" && a.backgroundColor && a.backgroundColor.length === 1 && a.backgroundColor[0] === "65c9ff" && (a.backgroundColor = []), a.facialHairProbability !== 100 && ((i = l.top) === null || i === void 0 ? void 0 : i.name) === "hijab" && (a.facialHair = void 0);
}
const G = {
  ...
  var l, t;
  const c = F1({ prng: e, options: a }), r = N1({ prng: e, options: a });
  return B1({ prng: e, options: a, components: c, colors: r }), {
    attributes: {
      viewBox: "0 0 280 280",
      fill: "none",
      "shape-rendering": "auto"
    },
    body: `<g transform="translate(8)">${(t = (l = c.style) === null || l === void 0 ? void 0 : l.value(c, r)) !== null && t !== void 0 ? t : ""}</g>`,
    extra: () => ({
      ...Object.entries(c).reduce((i, [s, o]) => (i[s] = o == null ? void 0 : o.name, i), {}),
      ...Object.entries(r).reduce((i, [s, o]) => (i[`${s}Color`] = o, i), {})
    })
  };
...
function v(e) {
  return Object.freeze(e.map(P1));
}
const T1 = G.properties, L = {
  blue: { id: "blue", label: { en: "Blue", zh: "蓝色" }, value: "dbeafe" },
  red: { id: "red", label: { en: "Red", zh: "红色" }, value: "fee2e2" },
  green: { id: "green", label: { en: "Green", zh: "绿色" }, value: "dcfce7" },
  purple: { id: "purple", label: { en: "Purple", zh: "紫色" }, value: "ede9fe" },
  amber: { id: "amber", label: { en: "Amber", zh: "琥珀色" }, value: "fef3c7" },
  coral: { id: "coral", label: { en: "Coral", zh: "珊瑚色" }, value: "ffe0d4" }
}, L1 = {
  blue: ["2563eb", "38bdf8", "0f766e", "facc15"],
  red: ["dc2626", "fb7185", "f97316", "7c3aed"],
  green: ["16a34a", "22c55e", "0ea5e9", "f59e0b"],
  purple: ["7c3aed", "a855f7", "ec4899", "22d3ee"],
  amber: ["d97706", "facc15", "fb923c", "14b8a6"],
  coral: ["ff6b4a", "f97316", "06b6d4", "e11d48"]
}, j1 = [
  { id: "solid", label: { en: "Solid", zh: "纯色" } },
  { id: "trianglify", label: { en: "Trianglify", zh: "三角拼接" } },
  { id: "meteor", label: { en: "Meteor", zh: "流星" } },
  { id: "wave", label: { en: "Wave", zh: "波浪" } }
], U1 = [
  { id: "transparent", label: { en: "Transparent", zh: "透明" }, style: "transparent", value: "transparent" },
  ...j1.flatMap(
    (e) => Object.keys(L).map((a) => {
      const l = L[a];
      return {
        id: `${e.id}-${l.id}`,
        label: {
          en: `${e.label.en} / ${l.label.en}`,
          zh: `${e.label.zh} / ${l.label.zh}`
        },
        style: e.id,
        value: l.value,
        accents: L1[a]
  ...
  a55728: { id: "auburn", label: { en: "Auburn", zh: "赤褐发" }, value: "a55728" },
  "2c1b18": { id: "black", label: { en: "Black", zh: "黑发" }, value: "2c1b18" },
  b58143: { id: "chestnut", label: { en: "Chestnut", zh: "栗棕发" }, value: "b58143" },
  d6b370: { id: "sand", label: { en: "Sand", zh: "沙金发" }, value: "d6b370" },
  724133: { id: "brown", label: { en: "Brown", zh: "棕发" }, value: "724133" },
  "4a312c": { id: "dark-brown", label: { en: "Dark brown", zh: "深棕发" }, value: "4a312c" },
  f59797: { id: "pink", label: { en: "Pink", zh: "粉发" }, value: "f59797" },
  ecdcbf: { id: "blonde", label: { en: "Blonde", zh: "金发" }, value: "ecdcbf" },
  c93305: { id: "copper", label: { en: "Copper", zh: "铜红发" }, value: "c93305" },
  e8e1e1: { id: "silver", label: { en: "Silver", zh: "银发" }, value: "e8e1e1" }
}, G1 = {
  614335: { id: "espresso", label: { en: "Espresso", zh: "深棕肤" }, value: "614335" },
  d08b5b: { id: "bronze", label: { en: "Bronze", zh: "古铜肤" }, value: "d08b5b" },
  ae5d29: { id: "tan", label: { en: "Tan", zh: "小麦肤" }, value: "ae5d29" },
  edb98a: { id: "warm", label: { en: "Warm beige", zh: "暖米肤" }, value: "edb98a" },
  ffdbb4: { id: "peach", label: { en: "Peach", zh: "蜜桃肤" }, value: "ffdbb4" },
  fd9841: { id: "golden", label: { en: "Golden", zh: "金棕肤" }, value: "fd9841" },
  f8d25c: { id: "sunlit", label: { en: "Sunlit", zh: "阳光肤" }, value: "f8d25c" }
}, z = {
  bob: { en: "Bob", zh: "波波头" },
  bun: { en: "Bun", zh: "丸子头" },
  curly: { en: "Curly", zh: "卷发" },
  curvy: { en: "Curvy", zh: "弧形长发" },
  dreads: { en: "Dreads", zh: "脏辫" },
  frida: { en: "Frida", zh: "花饰长发" },
  fro: { en: "Afro", zh: "爆炸卷" },
  froBand: { en: "Afro band", zh: "发带爆炸卷" },
  longButNotTooLong: { en: "Medium long", zh: "中长发" },
  miaWallace: { en: "Blunt bob", zh: "齐刘海短发" },
  shavedSides: { en: "Shaved sides", zh: "侧削短发" },
  straight02: { en: "Straight long", zh: "直长发" },
  straight01: { en: "Straight side part", zh: "侧分直发" },
  straightAndStrand: { en: "Straight strand", zh: "垂缕直发" },
  dreads01: { en: "Short dreads", zh: "短脏辫" },
  dreads02: { en: "Long dreads", zh: "长脏辫" },
  frizzle: { en: "Frizzle", zh: "蓬松卷发" },
  shaggy: { en: "Shaggy", zh: "蓬乱短发" },
  shaggyMullet: { en: "Shaggy mullet", zh: "狼尾短发" },
  shortCurly: { en: "Short curly", zh: "短卷发" },
  shortFlat: { en: "Short flat", zh: "平顶短发" },
  shortRound: { en: "Short round", zh: "圆短发" },
  shortWaved: { en: "Short waved", zh: "短波浪发" },
  sides: { en: "Side cut", zh: "侧分短发" },
  theCaesar: { en: "Caesar", zh: "凯撒短发" },
  theCaesarAndSidePart: { en: "Caesar side part", zh: "侧分凯撒发" },
  bigHair: { en: "Big hair", zh: "蓬松大卷" },
  default: { en: "Default", zh: "默认" },
  closed: { en: "Closed", zh: "闭眼" },
  cry: { en: "Cry", zh: "哭泣" },
  eyeRoll: { en: "Eye roll", zh: "翻白眼" },
  happy: { en: "Happy", zh: "开心" },
  hearts: { en: "Hearts", zh: "爱心眼" },
  side: { en: "Side glance", zh: "侧目" },
  squint: { en: "Squint", zh: "眯眼" },
  surprised: { en: "Surprised", zh: "惊讶" },
  winkWacky: { en: "Wacky wink", zh: "俏皮眨眼" },
  wink: { en: "Wink", zh: "眨眼" },
  xDizzy: { en: "Dizzy", zh: "眩晕" },
  angryNatural: { en: "Natural angry", zh: "自然生气眉" },
  defaultNatural: { en: "Natural default", zh: "自然默认眉" },
  flatNatural: { en: "Natural flat", zh: "自然平眉" },
  frownNatural: { en: "Natural frown", zh: "自然皱眉" },
  raisedExcited: { en: "Raised excited", zh: "兴奋挑眉" },
  raisedExcitedNatural: { en: "Natural raised", zh: "自然挑眉" },
  sadConcernedNatural: { en: "Natural sad", zh: "自然忧伤眉" },
  unibrowNatural: { en: "Natural unibrow", zh: "自然连眉" },
  upDownNatural: { en: "Natural up down", zh: "自然高低眉" },
  angry: { en: "Angry", zh: "生气眉" },
  sadConcerned: { en: "Sad concerned", zh: "忧伤眉" },
  upDown: { en: "Up down", zh: "高低眉" },
  concerned: { en: "Concerned", zh: "担心嘴" },
  disbelief: { en: "Disbelief", zh: "怀疑嘴" },
  eating: { en: "Eating", zh: "进食嘴" },
  grimace: { en: "Grimace", zh: "咧嘴" },
  screamOpen: { en: "Open scream", zh: "惊呼嘴" },
  serious: { en: "Serious", zh: "严肃嘴" },
  smile: { en: "Smile", zh: "微笑" },
  sad: { en: "Sad", zh: "难过" },
  tongue: { en: "Tongue", zh: "吐舌" },
  twinkle: { en: "Twinkle", zh: "俏皮笑" },
  vomit: { en: "Vomit", zh: "难受嘴" },
  beardLight: { en: "Light beard", zh: "浅胡子" },
  beardMajestic: { en: "Full beard", zh: "浓胡子" },
  beardMedium: { en: "Medium beard", zh: "中胡子" },
  moustacheFancy: { en: "Fancy moustache", zh: "卷翘胡" },
  moustacheMagnum: { en: "Magnum moustache", zh: "浓八字胡" },
  none: { en: "None", zh: "无" },
  blazerAndShirt: { en: "Blazer and shirt", zh: "西装衬衫" },
  blazerAndSweater: { en: "Blazer and sweater", zh: "西装毛衣" },
  collarAndSweater: { en: "Collar sweater", zh: "翻领毛衣" },
  graphicShirt: { en: "Graphic shirt", zh: "图案上衣" },
  hoodie: { en: "Hoodie", zh: "连帽衫" },
  overall: { en: "Overall", zh: "背带装" },
  shirtCrewNeck: { en: "Crew neck", zh: "圆领衫" },
  shirtScoopNeck: { en: "Scoop neck", zh: "大圆领" },
  shirtVNeck: { en: "V-neck", zh: "V领衫" },
  kurt: { en: "Kurt glasses", zh: "柯特眼镜" },
  prescription01: { en: "Prescription 1", zh: "光学眼镜一" },
  prescription02: { en: "Prescription 2", zh: "光学眼镜二" },
  round: { en: "Round glasses", zh: "圆框眼镜" },
  sunglasses: { en: "Sunglasses", zh: "墨镜" },
  wayfarers: { en: "Wayfarers", zh: "方框眼镜" },
...
function S(e) {
  var l;
  const a = T1[e];
  return [...((l = a == null ? void 0 : a.items) == null ? void 0 : l.enum) ?? (a == null ? void 0 : a.default) ?? []];
}
function b(e) {
  return e.replace(/([a-z0-9])([A-Z])/g, "$1 $2").replace(/(\d+)/g, " $1").replace(/\s+/g, " ").trim().replace(/^./, (a) => a.toUpperCase());
}
function q1(e, a) {
  const l = z[a];
  return {
    id: a,
    label: (l == null ? void 0 : l.en) ?? b(a),
    labels: l,
    svg: `<g data-dicebear-option="${e}" data-dicebear-value="${a}"/>`
  };
}
function W(e, a, l, t) {
  return {
    ...
    labels: t,
    svg: l.map(
      (c) => `<g data-dicebear-option="${c.name}" data-dicebear-value="${c.value}"/>`
    ).join("")
  };
}
function j(e, a) {
  return {
    ...
    label: a,
    labels: z.none,
    svg: `<g data-dicebear-option="${e}" data-dicebear-value="none"/>`
  };
}
function X1(e, a) {
  return {
    id: a,
    label: a === "transparent" ? "Transparent" : `#${a.toUpperCase()}`,
    svg: `<g data-dicebear-option="${e}" data-dicebear-value="${a}"/>`
  };
}
function K1({
  ...
  return {
    ...
    label: a.en,
    labels: a,
    svg: `<g data-openavatar-background-style="${l}" data-openavatar-background-color="${t}"${c ? ` data-openavatar-background-accents="${c.join(",")}"` : ""}/>`
  };
}
function V(e) {
  return (e === "top" ? S(e).filter((l) => !W1.has(l)) : S(e)).map((l) => q1(e, l));
}
function Y1(e, a) {
  return S(e).map((l) => {
    const t = a == null ? void 0 : a[l];
    return t ? {
      id: t.id,
      label: t.label.en,
      labels: t.label,
      svg: `<g data-dicebear-option="${e}" data-dicebear-value="${t.value}"/>`
    } : X1(e, l);
  });
}
function J1() {
  return V("top").flatMap(
    (e) => S("hairColor").map((a) => {
      var t, c, r;
      const l = I1[a];
      return W(
        `${e.id}-${l.id}`,
        `${((t = e.labels) == null ? void 0 : t.en) ?? e.label} / ${l.label.en}`,
        [
          { name: "top", value: e.id },
          { name: "hairColor", value: l.value }
        ],
        {
          en: `${((c = e.labels) == null ? void 0 : c.en) ?? e.label} / ${l.label.en}`,
          zh: `${((r = e.labels) == null ? void 0 : r.zh) ?? e.label} / ${l.label.zh}`
        }
      );
    })
  );
...
function Q1() {
  return S("eyes").flatMap(
    (e) => S("eyebrows").flatMap(
      (a) => S("mouth").map(
        (l) => {
          var t, c, r, i, s, o;
          return W(
            ...
            [
              { name: "eyes", value: e },
              { name: "eyebrows", value: a },
              { name: "mouth", value: l }
            ],
            {
              en: `${((t = z[e]) == null ? void 0 : t.en) ?? b(e)} / ${((c = z[a]) == null ? void 0 : c.en) ?? b(a)} / ${((r = z[l]) == null ? void 0 : r.en) ?? b(l)}`,
              zh: `${((i = z[e]) == null ? void 0 : i.zh) ?? b(e)} / ${((s = z[a]) == null ? void 0 : s.zh) ?? b(a)} / ${((o = z[l]) == null ? void 0 : o.zh) ?? b(l)}`
            }
          );
        }
      )
...
const m = Object.freeze({
  background: U1.map(K1),
  hair: J1(),
  skin: Y1("skinColor", G1),
  expression: Q1(),
  beard: [j("facialHair", "No facial hair"), ...V("facialHair")],
  clothing: V("clothing"),
  eyewear: [j("accessories", "No eyewear"), ...V("accessories")]
}), g = Object.freeze({
  background: v(m.background),
  hair: v(m.hair),
  skin: v(m.skin),
  expression: v(m.expression),
  beard: v(m.beard),
  clothing: v(m.clothing),
  eyewear: v(m.eyewear)
});
function B(e) {
  return R1(e);
...
function e2() {
  return g.background.length * g.hair.length * g.skin.length * g.expression.length * g.beard.length * g.clothing.length * g.eyewear.length;
}
const l2 = "data:image/svg+xml;charset=UTF-8,", q = 256, t2 = 1024;
function c2(e) {
  return e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
}
function r2(e) {
  return typeof e != "number" || !Number.isFinite(e) || e <= 0 ? q : Math.min(Math.max(Math.floor(e), 1), t2);
}
function n2(e) {
  return e === "circle" ? 50 : e === "square" ? 0 : 18;
}
function i2(e, a) {
  var l;
  return (l = new RegExp(`data-dicebear-option="${a}" data-dicebear-value="([^"]+)"`).exec(
    e
  )) == null ? void 0 : l[1];
}
function A(e, a) {
...
function X(e) {
  var l;
  const a = (l = /data-openavatar-background-color="([^"]+)"/.exec(e.background.svg)) == null ? void 0 : l[1];
  return a && a !== "transparent" ? a : void 0;
}
function K(e) {
  var a;
  return (a = /data-openavatar-background-style="([^"]+)"/.exec(e.background.svg)) == null ? void 0 : a[1];
}
function o2(e) {
  var l;
  const a = (l = /data-openavatar-background-accents="([^"]+)"/.exec(e.background.svg)) == null ? void 0 : l[1];
  return a ? a.split(",").filter(Boolean) : [];
}
function d2(e, a) {
  let l = e + Math.imul(a + 1, 2654435761);
  return l ^= l >>> 16, l = Math.imul(l, 2246822507), l ^= l >>> 13, l = Math.imul(l, 3266489909), l ^= l >>> 16, (l >>> 0) / 4294967296;
}
function n(e, a, l, t) {
  return Math.round(l + d2(e, a) * (t - l));
}
function D(e, a) {
  return `<g data-openavatar-background-seed="${e}">${a}</g>`;
}
function s2(e, a, l) {
  const t = [e, ...a];
  return D(l, [
    `<rect fill="#${e}" width="280" height="280" x="0" y="0" />`,
    `<path d="M0 0h70L0 70Z" fill="#${t[1] ?? e}" opacity=".82"/>`,
    `<path d="M${n(l, 1, 54, 92)} 0h${n(l, 2, 72, 118)}L${n(l, 3, 24, 72)} ${n(l, 4, 96, 138)}Z" fill="#${t[2] ?? e}" opacity=".7"/>`,
    `<path d="M${n(l, 5, 142, 184)} 0h${n(l, 6, 88, 132)}v${n(l, 7, 68, 112)}L${n(l, 8, 96, 138)} ${n(l, 9, 52, 92)}Z" fill="#${t[3] ?? e}" opacity=".62"/>`,
    `<path d="M0 ${n(l, 10, 60, 90)}l${n(l, 11, 30, 64)} ${n(l, 12, 36, 68)}L0 ${n(l, 13, 154, 198)}Z" fill="#${t[4] ?? e}" opacity=".68"/>`,
    `<path d="M${n(l, 14, 28, 62)} ${n(l, 15, 102, 134)} ${n(l, 16, 96, 134)} ${n(l, 17, 58, 88)}l${n(l, 18, 48, 82)} ${n(l, 19, 68, 100)}-${n(l, 20, 72, 108)} ${n(l, 21, 32, 56)}Z" fill="#${t[1] ?? e}" opacity=".58"/>`,
    `<path d="M${n(l, 22, 162, 204)} ${n(l, 23, 136, 174)} 280 ${n(l, 24, 76, 112)}v${n(l, 25, 84, 120)}l-${n(l, 26, 52, 82)} ${n(l, 27, 34, 58)}Z" fill="#${t[2] ?? e}" opacity=".74"/>`,
    `<path d="M0 ${n(l, 28, 166, 194)}l${n(l, 29, 72, 104)} ${n(l, 30, 18, 34)}-${n(l, 31, 30, 54)} 80H0Z" fill="#${t[3] ?? e}" opacity=".6"/>`,
    `<path d="M${n(l, 32, 72, 104)} ${n(l, 33, 188, 214)}l${n(l, 34, 76, 108)}-${n(l, 35, 34, 58)} ${n(l, 36, 24, 42)} ${n(l, 37, 68, 96)}-${n(l, 38, 52, 82)} ${n(l, 39, 34, 58)}H${n(l, 40, 34, 60)}Z" fill="#${t[4] ?? e}" opacity=".7"/>`,
    `<path d="M${n(l, 41, 194, 226)} ${n(l, 42, 224, 250)}l${n(l, 43, 54, 86)}-${n(l, 44, 34, 60)}v90H${n(l, 45, 126, 164)}Z" fill="#${t[1] ?? e}" opacity=".64"/>`
  ].join(""));
}
function f2(e, a, l) {
  const t = [e, ...a];
  return D(l, [
    `<rect fill="#${e}" width="280" height="280" x="0" y="0" />`,
    `<path d="M-30 74 84-40" stroke="#${t[1] ?? e}" stroke-width="18" stroke-linecap="round" opacity=".7"/>`,
    `<path d="M${n(l, 1, 8, 48)} ${n(l, 2, 176, 226)} ${n(l, 3, 194, 240)} ${n(l, 4, -10, 34)}" stroke="#${t[2] ?? e}" stroke-width="${n(l, 5, 8, 14)}" stroke-linecap="round" opacity=".64"/>`,
    `<path d="M${n(l, 6, 118, 164)} 298 ${n(l, 7, 286, 326)} ${n(l, 8, 104, 152)}" stroke="#${t[3] ?? e}" stroke-width="${n(l, 9, 12, 20)}" stroke-linecap="round" opacity=".56"/>`,
    `<circle cx="${n(l, 10, 64, 108)}" cy="${n(l, 11, 62, 104)}" r="${n(l, 12, 10, 18)}" fill="#${t[1] ?? e}" opacity=".82"/>`,
    `<circle cx="${n(l, 13, 194, 236)}" cy="${n(l, 14, 52, 96)}" r="${n(l, 15, 7, 13)}" fill="#${t[4] ?? e}" opacity=".76"/>`,
    `<circle cx="${n(l, 16, 128, 176)}" cy="${n(l, 17, 188, 228)}" r="${n(l, 18, 9, 16)}" fill="#${t[2] ?? e}" opacity=".68"/>`
  ].join(""));
}
function u2(e, a, l) {
  const t = [e, ...a], c = n(l, 1, 76, 116), r = n(l, 2, 138, 172), i = n(l, 3, 204, 232);
  return D(l, [
    `<rect fill="#${e}" width="280" height="280" x="0" y="0" />`,
    `<path d="M0 ${c}c${n(l, 4, 34, 54)}-${n(l, 5, 26, 42)} ${n(l, 6, 72, 94)}-${n(l, 7, 26, 42)} ${n(l, 8, 112, 136)} 0s${n(l, 9, 72, 94)} ${n(l, 10, 26, 42)} 156 0v184H0Z" fill="#${t[1] ?? e}" opacity=".62"/>`,
    `<path d="M0 ${r}c${n(l, 11, 38, 58)}-${n(l, 12, 20, 34)} ${n(l, 13, 78, 102)}-${n(l, 14, 20, 34)} ${n(l, 15, 124, 146)} 0s${n(l, 16, 78, 100)} ${n(l, 17, 20, 34)} 148 0v124H0Z" fill="#${t[2] ?? e}" opacity=".72"/>`,
    `<path d="M0 ${i}c${n(l, 18, 42, 62)}-${n(l, 19, 14, 26)} ${n(l, 20, 86, 108)}-${n(l, 21, 14, 26)} 140 0s${n(l, 22, 76, 96)} ${n(l, 23, 14, 26)} 140 0v60H0Z" fill="#${t[3] ?? e}" opacity=".7"/>`
  ].join(""));
}
function h2(e, a) {
  const l = K(e), t = X(e), c = o2(e), r = a.split("~")[0] || a, i = U(`${r}:background`);
  return !t || !l || l === "solid" ? "" : l === "trianglify" ? s2(t, c, i) : l === "meteor" ? f2(t, c, i) : l === "wave" ? u2(t, c, i) : "";
}
function p2(e, a, l) {
  const t = h2(a, l);
  return t ? e.replace(/(<g mask="url\(#viewboxMask\)">)/, `$1${t}`) : e;
}
function v2(e, a) {
  const l = a ? `<title>${c2(a)}</title>` : "";
  return e.replace("<svg ", '<svg role="img" ').replace(/(<svg[^>]*>)/, `$1${l}`);
}
function m2(e, a, l, t) {
  const c = l.split("~")[0] || l, r = A(e.hair.svg, "hairColor"), i = X(e), s = K(e), o = A(
    e.beard.svg,
    "facialHair"
  ), u = A(
    e.eyewear.svg,
    ...
    size: t,
    radius: n2(a),
    top: [A(e.hair.svg, "top") ?? "shortWaved"],
    hairColor: [r ?? "2c1b18"],
    skinColor: [A(e.skin.svg, "skinColor") ?? "edb98a"],
    eyes: [A(e.expression.svg, "eyes") ?? "default"],
    eyebrows: [A(e.expression.svg, "eyebrows") ?? "default"],
    mouth: [A(e.expression.svg, "mouth") ?? "default"],
    nose: ["default"],
    base: ["default"],
    clothing: [A(e.clothing.svg, "clothing") ?? "shirtCrewNeck"]
  };
  return i && s === "solid" && (f.backgroundColor = [i], f.backgroundType = ["solid"]), o && o !== "none" ? (f.facialHair = [o], f.facialHairProbability = 100, f.facialHairColor = [r ?? "2c1b18"]) : f.facialHairProbability = 0, u && u !== "none" ? (f.accessories = [u], f.accessoriesProbability = 100) : f.accessoriesProbability = 0, f;
}
function Y(e, a, l, t, c = q) {
  const r = r2(c), i = y1(
    O1,
    m2(e, a, l, r)
  ).toString();
  return v2(p2(i, e, l), t);
}
function J(e) {
  return `${l2}${encodeURIComponent(e)}`;
}
const g2 = 3, Z2 = 1e3, M2 = [
  "background",
  "hair",
  "skin",
  "expression",
  ...
  "clothing",
  "eyewear"
], y2 = /^([A-Za-z]+):([A-Za-z0-9-]+)$/, b2 = {
  background: /* @__PURE__ */ new Set(["transparent"]),
  beard: /* @__PURE__ */ new Set(["none"]),
  eyewear: /* @__PURE__ */ new Set(["none"])
}, $2 = /* @__PURE__ */ new Set([
  "bob",
  "bun",
  "curly",
...
function Q(e) {
  return e === "circle" || e === "rounded-square" || e === "square" ? e : "rounded-square";
}
function C2(e, a) {
  var l;
  return (l = new RegExp(`data-dicebear-option="${a}" data-dicebear-value="([^"]+)"`).exec(
...
function A2(e) {
  const a = {};
  for (const l of e.split("~").slice(1)) {
    const t = y2.exec(l);
    if (!t)
      continue;
    const c = t[1], r = t[2];
...
function w(e, a, l, t) {
  const c = g[e], r = t[e] ? c.find((o) => o.id === t[e]) : void 0, i = b2[e], s = r ? c : i ? c.filter((o) => !i.has(o.id)) : c;
  return B(r ?? s[t1(a, s.length, l)]);
}
function z2(e, a, l) {
  const t = a.beard ? g.beard.find((r) => r.id === a.beard) : void 0;
  if (t)
    return B(t);
  const c = C2(l.svg, "top");
  return c && $2.has(c) ? B(g.beard.find((r) => r.id === "none") ?? g.beard[0]) : w("beard", e, 5, a);
}
function O(e) {
  const a = U(e), l = A2(e), t = w("hair", a, 2, l);
  return a2({
    background: w("background", a, 1, l),
    hair: t,
    skin: w("skin", a, 3, l),
    expression: w("expression", a, 4, l),
    beard: z2(a, l, t),
    clothing: w("clothing", a, 6, l),
    eyewear: w("eyewear", a, 7, l)
  });
}
function k2(e, a) {
  const l = e.split("~")[0], t = M2.map(
    (c) => `~${c}:${a[c].id}`
  ).join("");
  return `${l}${t}`;
}
...
function a1(e, a = {}) {
  const l = E(e), t = Q(a.shape), c = O(l), r = k2(l, c), i = Y(c, t, r, a.title, a.size);
  return Object.freeze({
    hash: r,
    svg: i,
    url: J(i),
...
function N2(e, a = {}) {
  if (!Number.isFinite(e) || e <= 0)
    return Object.freeze([]);
  const l = [], t = /* @__PURE__ */ new Set(), c = Math.min(Math.floor(e), Z2), r = c * 5 + 10;
  let i = 0;
  for (; l.length < c && i < r; ) {
    i += 1;
    const s = x2(a);
    t.has(s.hash) || (t.add(s.hash), l.push(s));
  }
  for (let s = 0; l.length < c; s += 1) {
    const o = `op-fallback-${s.toString(36)}:0`;
    t.has(o) || (t.add(o), l.push(a1(o, a)));
  }
...
const H2 = /^(?:https?:\/\/|\/\/|data:image\/|blob:)/i;
function e1(e) {
  return H2.test(e.trim());
}
function _2(e, a) {
  const l = a == null ? void 0 : a.trim();
  return l && !e1(l) ? l : e.trim();
}
function E2(e, a, l = {}) {
...
export {
  E2 as AutoAvatar,
  Z2 as MAX_RANDOM_AVATAR_BATCH,
  a1 as generateAvatar,
  w2 as generateAvatarSvg,
  S2 as generateAvatarUrl,
  x2 as generateRandomAvatar,
  N2 as generateRandomAvatars,
  V2 as getAvatarPartCatalog,
  F2 as getAvatarParts,
  B2 as getTotalCombinations,
  e1 as isAutoAvatarImageUrl,
  _2 as resolveAutoAvatarHash
};
